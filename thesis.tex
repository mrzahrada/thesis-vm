...
%\titul{}{Vladislava Muselikova}{Brno 2015}
\titul{Supplier evaluation system of the wood processing enterprise in the region of the CR, SK, HU and AT}{Vladislava Musel\'{i}kov\'{a}}{2014/2015}


\prohlasenizena{V~Brn\v{e} dne 2.kv\v{e}tna 2015}

% \podekovani{\noindent \textbf{Acknowledgement}\\Firstly, I wish to express my sincere thanks to my supervisor Ing. Petra Hlaváčková, Ph.D. for valuable help, comments and encouragement. \\
% Secondly, I am also grateful to Ing. Tomáš Kisiel for providing all neccesary data and information, which helped me to complete this thesis. \\
% Thirdly, I place on recors my endless thanks to Tomáš Zahradník and Isaac Cook for their patience, guidance and advice.
% Finally I take this opportunity to express my gratitude to all of the faculty members, who led me through my studies, to my family and my friends for their support.
% }

\podekovani{\noindent \textbf{Acknowledgement}\\Firstly, I wish to express my sincere thanks to my supervisor Ing. Petra Hlav\'{a}\v{c}kov\'{a},~ Ph.D. for valuable help, comments and encouragement. \\
Secondly, I am also grateful to Ing. Tom\'{a}\v{s} Kisiel for providing all neccesary data and information, which helped me to complete this thesis. \\
Thirdly, I place on recors my endless thanks to Tom\'{a}\v{s} Zahradn\'{i}k and Isaac Cook for their patience, guidance and advice. \\
Finally I take this opportunity to express my gratitude to all of the faculty members, who led me through my studies, to my family and my friends for their support.
}
...
\begin{table}[h]
  \centering
  \caption{Dickson's (1966) supplier or vendor selection criteria compared with situation by Weber et al. (2001)}
  \scalebox{0.6}{
  \begin{tabular}{lll}
...
Criteria indicated in the Table 2  are the ones which requires either both – wished position and category goal or just category goal.

% tab 2
\begin{table}[h]
  \caption{Criteria and their category goals and wished positions (IKEA directives)}\\
  \smallskip
  \begin{tabular}{l|c|c}
    Criteria                               & Wished Position                                            & Goal                                                      \\ \hline
    Lowest price (Current PuA) (EURO)      & \begin{tabular}[c]{@{}c@{}}95, 00 \\ (Spruce)\end{tabular} & \begin{tabular}[c]{@{}c@{}}100,80\\ (Spruce)\end{tabular} \\
...
\noindent Scale of evaluation: 1-4 according to below thresholds:\\
...
\begin{itemize}
  ...
  \begin{table}
    ...
    \caption{AHP weight distribution (Own sourcing)}
    \scalebox{0.7}{
    \parbox{.60\linewidth}{
    \centering
...
% tabs
\begin{table}[h]
  \caption{Comparison of the old and new results of supplier's evaluation (Own sourcing)}
  \centering
  \scalebox{0.7}{
...
%Lewis, H. (1947). Industrial purchasing, principles and practices. Chicago: Business publications..
\citace{lewis}{Lewis, H. 1947}{\autor{Lewis, H.} (1947). \nazev{Industrial purchasing, principles and practices.}
Chicago: Business publications}

% Monczka, R. and Trent, R. (2009). Purchasing and supply chain management (4th ed.). Cincinnati, Ohio: South-Western College Pub.
\citace{monczka}{Monczka, R. and Trent, R. 2009}{\autor{Monczka, R. and Trent, R.} (2009). \nazev{Purchasing and supply chain management (4th ed.).}
Cincinnati, Ohio: South-Western College Pub.}

% Weele, A. (2010). Purchasing & supply chain management: Analysis, strategy, planning and practice (5th ed.). Andover: Cengage Learning
\citace{weele}{Weele, A. (2010)}{\autor{Weele, A.} (2010). \nazev{Purchasing & supply chain management: Analysis, strategy, planning and practice (5th ed.).}
Andover: Cengage Learning}
% Nenadál, J. (2006). Management partnerství s dodavateli: Nové perspektivy firemního nakupování (1st ed.). Praha: Management Press.
\citace{nenadal}{Nenad\'{a}l, J. (2006)}{\autor{Nenad\'{a}l, J.} (2006). \nazev{Management partnerství s dodavateli: Nové perspektivy firemního nakupování (1st ed.).}
Praha: Management Press}
% Ochrana, F. (2004). Hodnocení veřejných projektů a zakázek (3rd ed.). Praha: ASPI.
\citace{ochrana}{Ochrana, F. (2004)}{\autor{Ochrana, F.} (2004). \nazev{Hodnocen\'{i} ve\'{r}ejn\'{y}ch projekt\r{u} a zak\'{a}zek (3rd ed.).}
Praha: ASPI.}
% Saaty, T. (1980). The analytic hierarchy process: Planning, priority setting, resource allocation. New York: McGraw-Hill International Book
\citace{saaty}{Saaty, T. (1980)}{\autor{Saaty, T.} (1980). \nazev{The analytic hierarchy process: Planning, priority setting, resource allocation.}
New York: McGraw-Hill International Book}
% Zhu, J. (2014). Quantitative Models for Performance Evaluation and Benchmarking Data Envelopment Analysis with Spreadsheets (3rd ed.). Cham: Springer International Publishing.
\citace{zhu}{Zhu, J. (2014)}{\autor{Zhu, J.} (2014). \nazev{Quantitative Models for Performance Evaluation and Benchmarking Data Envelopment Analysis with Spreadsheets (3rd ed.).}
...
\citace{giunipero}{Giunipero, L.C. and Brand, R. (1996)}{\autor{Giunipero, L.C. and Brand, R.} (1996). \nazev{Purchasing's role in supply chain management.}
International Journal of Logistics Management, Vol. 7 No. 1, pp. 29-38.}
% Davis, T. (1993), “Effective supply chain management”, Sloan Management Review, Vol. 34 No. 4, pp. 35-46.
\citace{davis}{Davis, T. (1993)}{\autor{Davis, T.} (1993). \nazev{Effective supply chain management}
Sloan Management Review, Vol. 34 No. 4, pp. 35-46.}
% De Boer, L., Van der Wegen, L. and Telgen, J., (1998). “Outranking methods in support of supplier selection”, European Journal of Purchasing and Supply Management, Vol. 4 , No. 2/3, pp. 109-118.
\citace{boer_0}{De Boer, L., Van der Wegen, L. and Telgen, J., (1998)}{\autor{De Boer, L., Van der Wegen, L. and Telgen, J.} (1998). \nazev{Outranking methods in support of supplier selection.}
European Journal of Purchasing and Supply Management, Vol. 4 , No. 2/3, pp. 109-118}
% Verma, R. and Pullman, M. E. (1998). “An analysis of the supplier selection process” Omega, Vol. 26, No. 6, pp. 739-750.
\citace{verma}{Verma, R. and Pullman, M. E. (1998)}{\autor{Verma, R. and Pullman, M. E.} (1998). \nazev{An analysis of the supplier selection process.}
Omega, Vol. 26, No. 6, pp. 739-750.}
% Dickson, G. W. (1966). “An Analysis of Vendor Selection Systems and Decisions,” Journal of Purchasing, Vol. 2, No. 4, pp. 5–17.
\citace{dickson}{Dickson, G. W. (1966).}{\autor{Dickson, G. W.} (1966). \nazev{An Analysis of Vendor Selection Systems and Decisions.}
Journal of Purchasing, Vol. 2, No. 4, pp. 5–17}
% Weber, C. A., J. R. Current, and W. C. Benton (1991). “Vendor Selection Criteria and Methods,” European Journal of Operational Research, Vol. 50, No. 1, pp. 2–18.
\citace{weber}{Weber, C. A., J. R. Current, and W. C. Benton (1991)}{\autor{Weber, C. A., J. R. Current, and W. C. Benton} (1991). \nazev{Vendor Selection Criteria and Methods.}
European Journal of Operational Research, Vol. 50, No. 1, pp. 2–18.}
% Lehmann, D. and O’Shaughnessy, J. (1982). “Decision criteria used in buying different categories of products”, Journal of Purchasing and Materials Management, Vol. 18 No. 1, pp. 9-14.
\citace{lehmann}{Lehmann, D. and O'Shaughnessy, J.}{\autor{Lehmann, D. and O’Shaughnessy, J.} (1982). \nazev{Decision criteria used in buying different categories of products.}
Journal of Purchasing and Materials Management, Vol. 18 No. 1, pp. 9-14}
...
\citace{vokurka}{Vokurka, R. J., Choobineh, J. and Vadi L., (1996)}{\autor{Vokurka, R. J., Choobineh, J. and Vadi L.} (1996). \nazev{A prototype expert system for the evaluation and selection of potential suppliers.}
International Journal of Operations & Production Management, Vol. 16, No. 12, pp. 106 - 127}
...
\citace{barbarosoglu}{Barbarosoglu, G. and Yazgac, T. (1997)}{\autor{Barbarosoglu, G. and Yazgac, T.} (1997). \nazev{An application of the analytic hierarchy process to the supplier selection problem.}
Production and inventory management journal, Vol. 38,  No 1, pp. 14-21}
% Altinoz, C., Kilduff, P. and Winchester Jr., (2010). “Current issues and methods in supplier selection”, Journal of the Textile Institute, Vol. 92, No. 2, pp. 128-141.
\citace{altinoz}{Altinoz, C., Kilduff, P. and Winchester Jr., (2010)}{\autor{Altinoz, C., Kilduff, P. and Winchester Jr.} (2010). \nazev{Current issues and methods in supplier selection.}
Journal of the Textile Institute, Vol. 92, No. 2, pp. 128-141}
% De Boer, L., Labro, E., Molrlacchi, P., (2001). A review of methods supporting supplier selection. European Journal of Purchasing and Supply Management, Vol. 1, No. 7., pp. 75–89
\citace{boer_1}{De Boer, L., Labro, E., Molrlacchi, P., (2001)}{\autor{De Boer, L., Labro, E., Molrlacchi, P.} (2001). \nazev{A review of methods supporting supplier selection.}
European Journal of Purchasing and Supply Management, Vol. 1, No. 7., pp. 75–89}
% Pal O., Gupta A. K., Garg  R. K., (2013). “Supplier Selection Criteria and Methods in SupplyChains: A Review”,International Journal of Social, Education, Economics and Management Engineering, Vol. 7, No. 10, pp. 1396 - 1401
\citace{pal}{Pal O., Gupta A. K., Garg  R. K., (2013)}{\autor{Pal O., Gupta A. K., Garg  R. K.} (2013). \nazev{Supplier Selection Criteria and Methods in SupplyChains: A Review.}
International Journal of Social, Education, Economics and Management Engineering, Vol. 7, No. 10, pp. 1396 - 1401}
% Timmerman, E. (1986). “An Approach to Vendor Performance Evaluation,” Journal of Purchasing and Materials Management, Vol. 22, No. 4, pp. 2–8.
\citace{}{Timmerman, E. (1986)}{\autor{Timmerman, E.} (1986). \nazev{An Approach to Vendor Performance Evaluation.}
Journal of Purchasing and Materials Management, Vol. 22, No. 4, pp. 2–8}
% Ding, H. W., L. Benyoucef and X. L. Xie (2005), “A Simulation Optimization Methodology for Supplier Selection Problem”, International Journal of Computer Integrated Manufacturing, Vol. 18, No. 2-3, pp. 210–224
\citace{ding}{Ding, H. W., L. Benyoucef and X. L. Xie (2005)}{\autor{Ding, H. W., L. Benyoucef and X. L. Xie} (2005). \nazev{A Simulation Optimization Methodology for Supplier Selection Problem.}
International Journal of Computer Integrated Manufacturing, Vol. 18, No. 2-3, pp. 210–224}
% Min, H. (1994). “International Supplier Selection: a Multi-attribute Utility Approach”, International Journal of Physical Distribution and Logistics Management, Vol. 5, No. 24, pp. 24–33
\citace{}{Min, H. (1994)}{\autor{Min, H.} (1994). \nazev{International Supplier Selection: a Multi-attribute Utility Approach.}
International Journal of Physical Distribution and Logistics Management, Vol. 5, No. 24, pp. 24–33}
% Mendoza, A. (2007). “Effective methodologies for supplier selection and order quantity allocation” (Unpublished doctoral dissertation), The Pennsylvania State University The Graduate School, Pennsylvania, USA
\citace{}{Mendoza, A. (2007)}{\autor{Mendoza, A.} (2007). \nazev{Effective methodologies for supplier selection and order quantity allocation.}
(Unpublished doctoral dissertation), The Pennsylvania State University The Graduate School, Pennsylvania, USA}
% Menšíková, M.(2009). “Návrh systému hodnocení dodavatelů dle ČSN ISO 9001:2000” (Unpublished doctoral dissertation), Vysoké učení technické v Brně, Fakulta podnikatelská, Brno, Czech republic
\citace{}{Men\v{s}\'{i}kov\'{a}, M.(2009)}{\autor{Men\v{s}\'{i}kov\'{a}, M.} (2009). \nazev{N\'{a}vrh syst\'{e}mu hodnocen\'{i} dodavatel\r{u} dle \v{C}SN ISO 9001:2000.}
(Unpublished doctoral dissertation), Vysok\'{e} u\v{c}en\'{i} technick\'{e} v Brn\v{e}, Fakulta podnikatelsk\'{a}, Brno, Czech republic}
%About IKEA - IKEA. (n.d.). Retrieved April 5, 2015, from http://www.ikea.com/ms/en_GB/about_ikea/
\citace{}{}{\autor{IKEA} (n.d.) Retrieved April~5,~2015, from~http://www.ikea.com/ms/en\_GB/about\_ikea/}


\end{literatura}

\kapitola{List of figures}
